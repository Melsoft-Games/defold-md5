...
static int calculate_md5(lua_State* L)
{
	...
	MD5(static_cast<void*>(aaa), strlen(inp), buffer);
...
dmExtension::Result AppInitializeMD5(dmExtension::AppParams* params)
{
	return dmExtension::RESULT_OK;
}

dmExtension::Result InitializeMD5(dmExtension::Params* params) {
	LuaInit(params->m_L);
	return dmExtension::RESULT_OK;
}

dmExtension::Result AppFinalizeMD5(dmExtension::AppParams* params) {
	return dmExtension::RESULT_OK;
}

dmExtension::Result FinalizeMD5(dmExtension::Params* params) {
	return dmExtension::RESULT_OK;
}

DM_DECLARE_EXTENSION(MD5, LIB_NAME, AppInitializeMD5, AppFinalizeMD5, InitializeMD5, 0, 0, FinalizeMD5)
